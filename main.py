...
while True:
    ...
    # draw titles
    sc.blit(title_tetris, (485, 30))
    sc.blit(title_score, (535, 380))
    sc.blit(font.render(str(score), True, pygame.Color('white')), (590, 435))
    sc.blit(title_record, (525, 480))
    sc.blit(font.render(record, True, pygame.Color('gold')), (590, 535))
    # game over
    for i in range(W):
        if field[0][i]:
